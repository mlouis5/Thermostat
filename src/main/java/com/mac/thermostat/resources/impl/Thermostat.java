...
import com.mac.thermostat.resources.impl.subresource.Program;
 ...
 * * - Some thermostat models may not support all program modes.
 */
...
public class Thermostat implements Resource {
     ...
     * Request Type: GET
     * Data Format: double, representing temp in Fahrenheit
     */
    @RequestType
    @JsonProperty("temp")
    private double temp;
     ...
     * Data Format: integer, 0=OFF, 1=HEAT, 2=COOL, 3=AUTO
     */
     ...
     * Request Type: GET, POST
     * Data Format: integer, 0=AUTO, 1=AUTO/CIRCULATE, 2=ON
     */
    @RequestType(types = {RestType.GET, RestType.POST})
    @JsonProperty("fmode")
    private int fMode;
    /**
     * Description: Target temperature temporary override
     * Request Type: GET
     * Data Format: integer, 
     * 0=Override is disabled, 1=Override is enabled
     * Note: Firmware versions prior to
     * 1.04 can return any non-zero
     * value if override is enabled.
     */
    @RequestType
    @JsonProperty("override")
    private int override;
    /**
     * Description: Target temperature Hold status
     * Request Type: GET, POST
     * Data Format: integer, 0=Hold is disabled, 1=Hold is enabled
     */
    @RequestType(types = {RestType.GET, RestType.POST})
    @JsonProperty("hold")
    private int hold;
    /**
     * Description: Temporary Target Heat Setpoint: Sets target and MODE
     * Request Type: GET, POST
     * Data Format: double, Floating point representing temperature value in degree Fahrenheit. #
     */
    @RequestType(types = {RestType.GET, RestType.POST})
    @JsonProperty("t_heat")
    private double tHeat;
    /**
     * Description: Temporary Target Cool Setpoint: Sets target and MODE
     * Request Type: GET, POST
     * Data Format: double, Floating point representing temperature value in degree Fahrenheit. #
     */
    @RequestType(types = {RestType.GET, RestType.POST})
    ...
    /**
     * Description: Temporary Target Heat Setpoint
     * Request Type: GET, POST
     * Data Format: double, Floating point representing temperature value in degree Fahrenheit.
     */
    @RequestType(types = {RestType.GET, RestType.POST})
    ...
    /**
     * Description: Temporary Target Cool Setpoint
     * Request Type: GET, POST
     * Data Format: double, Floating point representing temperature value in degree Fahrenheit.
     */
    @RequestType(types = {RestType.GET, RestType.POST})
    ...
    /**
     * Description: Absolute Target Heat Setpoint
     * Request Type: GET, POST
     * Data Format: double, Floating point representing temperature value in degree Fahrenheit.
     */
    @RequestType(types = {RestType.GET, RestType.POST})
    ...
    /**
     * Description: Absolute Target Cool Setpoint
     * Request Type: GET, POST
     * Data Format: double, Floating point representing temperature value in degree Fahrenheit.
     */
    @RequestType(types = {RestType.GET, RestType.POST})
    ...
    /**
     * Description: Absolute Target Temperature Mode
     * Request Type: POST
     * Data Format: Integer representing the absolute target temperature mode.
     * 0 – Disable Absolute Target Temperature Mode
     * 1 – Enable Absolute Target Temperature Mode
     */
    @RequestType(types = {RestType.POST})
    @JsonProperty("a_mode")
    private int aMode;
    /**
     * Description: Target Temperature POST type
     * Request Type: GET
     * Data Format: Integer value that indicates whether a POST on<br>
     * t_heat/t_cool will result in temporary or absolute temperature change.
     * 0: Temporary Target Temperature
     * 1: Absolute Target Temperature
     * 2: Unknown 
     * This attribute is deprecated and
     * will be obsoleted in future
     * versions of the API. #
     */ 
    ...
    private int tState;
    /**
     * Description: Fan Operating State
     * Request Type: GET
     * Data Format: Integer value:
     * 0: OFF
     * 1: ON
    ...
    private int fState;
    /**
     * Description: Thermostat’s internal representation of time
     * Request Type: GET, POST
     * Data Format: JSON object with the following fields: 
     * day, hours, minutes.
     * day: Integer value representing
     * the day of the week, with day 0
     * being Monday.
     * hour: Integer value representing
     * number of hours elapsed since
     * midnight.
     * minutes: Integer value
     * representing number of minutes
     ...
     * Request Type: GET, POST
     * Data Format: Integer representing the current program mode:*
     * 0: Program A
     * 1: Program B
     * 2: Vacation
     * 3: Holiday
    ...
    /**
     * Description: Current operating target
     * Request Type: GET
     * Data Format: Integer representing the current target operating mode. For
     * example, if the thermostat is in AUTO mode and operating
     * toward a cool target, then this value will be 2.
     * Valid values:
     * 0: Off
     * 1: Heat
     * 2: Cool
